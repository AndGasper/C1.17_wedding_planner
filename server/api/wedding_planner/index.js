...
import { index, getWeddingPlanner, create, updateWeddingPlanner, deleteWeddingPlanner, isLoggedIn, logout, loggedIn, getPredetermined } from './wedding_planner.controller';
...
router.get('/predetermined', getPredetermined);
